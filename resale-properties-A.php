...
//collect
	...
	if (isset($_POST ['search'])){
		...
		$query = mysql_query("SELECT * FROM propertyDetails WHERE property_type LIKE '%$searchq%' OR property_amount LIKE '%$searchq%' OR property_location LIKE '%$searchq%'  OR property_image LIKE '%$searchq%' " )or die("could not search");
...
<img src="images/test2.jpg">  <br> 
	<h3 style="color:red; font-weight: bold;">PHP: <br><small>20,000,00.00</small> </h3>
	<h3>PROPERTY: <br><small>ALBAY- House and Lot </small> </h3>
...
<img src="images/test3.jpg"><br> 
	<h3 style="color:red; font-weight: bold;">PHP: <br><small>20,000,00.00</small> </h3>
	<h3>PROPERTY: <br><small>APARI- House and Lot </small> </h3>
